...
1. The number of periods and groups in the periodic table
   a) 6, 16
   b) 7, 17
   c) 8, 18
   d) 7, 18

2. The basis of modern periodic law
   a) atomic number
   b) atomic mass
   c) isotopic mass
   d) number of neutrons

3. _____ group contains the member of halogen
   a) 17th
   b) 15th
   c) 18th
   d) 16th
...
6. In the alumino thermic process the role of Al is
   a) oxidizing agent
   b) reducing agent
...
4. If the distance between two Cl atoms in Cl₂ molecule is 1.98Å, then the radius of Cl atom is ________.
...
1. A is a reddish brown metal, which combines with O₂ at <1370K gives B, a black coloured compound. At a temperature >1370K, A gives C which is red in colour. Find A, B and C with reaction.

2. A is a silvery white metal. A combines with O₂ to form B at 800°C, the alloy of A is used in making the aircraft. Find A and B
...
1. Metal A belongs to period 3 and group 13. A under hot condition reacts with steam to form B. A with strong alkali forms C. Find A, B and C with reactions
