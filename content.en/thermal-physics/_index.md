...
**1\. Linear expansion:** When a body is heated or cooled, the
...
**1) Real expansion** If a liquid is heated directly without using
...
**Data:** Initial pressure (P1)= P Final Pressure (P2) = 4P Initial volume (V1) = 20cc = 20cm3
