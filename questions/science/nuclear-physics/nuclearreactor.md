...
```markdown
  ...
  nuclear power plant was the Madras Atomic Power Station (MAPS) at Kalpakkam,
  Tamil Nadu, commissioned in 1984. If referring to the first research reactor,
  the answer is Mumbai; if referring to the first power plant, it is Kalpakkam.
