...
| விசை செயல்பாடு | படம் | தொகுப்பயன் விசை (F_தொகு) மதிப்பு |
|--------------|------|----------------------------------|
| ஒத்த இணை விசைகள் ஒரே திசையில் செயல்பட்டால் | F₁ → □, F₂ → □ | F_தொகு = F₁ + F₂ |
| சமமற்ற மதிப்புகள் கொண்ட இணை விசைகள் எதிரெதிர் திசையில் செயல்பட்டால் | F₁ → □ ← F₂ | F_தொகு = F₁ - F₂ (F₁ &gt; F₂ எனில்) |
| சமமான விசைகள் எதிரெதிர் திசையில் ஒரே நேரத்தில் நேர்கோட்டில் செயல்பட்டால் | F₁ → □ ← F₂ | F_தொகு = 0 எனில் (F₁ = F₂) |
