...
|---------|-----------|------|
| புரப்பேன் | {{< katex display=true >}}
(CH_3-CH_2-CH_3)
{{< /katex >}}| நிறைவுற்ற சேர்மம் |
| புரப்பீன் | {{< katex display=true >}}
(CH_3-CH=CH_2)
{{< /katex >}}| நிறைவற்ற சேர்மம் |
...
![Figure: Classification of organic compounds - Flowchart showing open chain and closed chain compounds with subcategories](figure_11_1_classification.png)

**கார்பனா (ஓரின) வளையச் சேர்மங்கள்:**

| வகை | வேதி வாய்ப்பாடு | கட்டமைப்பு |
|-----|---------------|-----------|
| வளைய பியூட்டேன் (அலிசைக்ளிக் சேர்மங்கள்) | {{< katex display=true >}}
(C_4H_8)
{{< /katex >}}| ![Cyclobutane](cyclobutane.png) |
| பென்சீன் (அரோமாட்டிக் சேர்மங்கள்) | {{< katex display=true >}}
(C_6H_6)
{{< /katex >}}| ![Benzene](benzene.png) |

**பல்லின வளையச் சேர்மங்கள்:**

| சேர்மம் | வாய்ப்பாடு |
|---------|-----------|
| பியூரான் | {{< katex display=true >}}
(C_4H_4O)
{{< /katex >}}
 |
...
{{< katex display=true >}}
(CH_4)
{{< /katex >}} கொண்டு {{< katex display=true >}}
(n = 1, 2, 3, ...{{< /katex >}}) கார்பன்களுக்கிடையே ஒற்றைப் பிணைப்புடன் கொண்ட சேர்மங்கள் அல்கேன்கள் ஆகும். {{< katex display=true >}}
(n = 1)
{{< /katex >}}
 என எடுத்துக் கொள்ளும்போது அதன் முதல் உறுப்பான மீத்தேன் ({{< katex display=true >}}
(CH_4)
{{< /katex >}}
)
) கிடைக்கிறது.
...
(C_nH_{2n})
{{< /katex >}}
 என்கிற பொதுவாய்ப்பாட்டுடன் கொண்ட கார்பன்களுக்கிடையே இரட்டைப் பிணைப்புடன் கொண்ட சேர்மங்கள் அல்கீன்கள் ஆகும். {{< katex display=true >}}
(n = 2 {{< /katex >}})என எடுத்துக் கொள்ளும்போது அதன் முதல் உறுப்பான எத்திலீன ({{< katex display=true >}}
(C_2H_4)
{{< /katex >}}
) கிடைக்கிறது. இவை நிறைவற்ற கரிமச் சேர்மங்கள் ஆகும்.

#### அல்கைன்கள்

கார்பன்களுக்கிடையே முப்பிணைப்புடன் கொண்ட சேர்மங்கள் அல்கைன்கள் ஆகும். இதன் முதல் உறுப்பு அசிட்டிலீன் {{< katex display=true >}}
(C_2H_2)
{{< /katex >}}
 ஆகும்.
...
| கார்பன் எண்ணிக்கை | அல்கேன்கள் ({{< katex display=true >}}(C_nH_{2n+2{{< /katex >}}) | அல்கீன்கள் ({{< katex display=true >}}(C_nH_{2n}){{< /katex >}}) | அல்கைன்கள் ({{< katex display=true >}}(C_nH_{2n-2}){{< /katex >}}) |
|------------------|---------------------------|--------------------------|---------------------------|
| 1 | மீத்தேன்({{< katex display=true >}}(CH_4){{< /katex >}}) | - | - |
| 2 | ஈத்தேன் ({{< katex display=true >}}
(C_2H_6{{< /katex >}}) | எத்தீன் ({{< katex display=true >}}
(C_2H_4{{< katex display=true >}}
() | எத்தைன் ()
{{< /katex >}}
C_2H_2)
{{< /katex >}}
)|
| 3 | புரப்பேன் ({{< katex display=true >}}
(C_3H_8{{< katex display=true >}}
() | புரப்பீன் ({{< katex display=true >}}
(C_3H_6)
{{< /katex >}}
) | புரப்பைன் ()
...
| 4 | பியூட்டேன் ({{< katex display=true >}}
(C_4H_{10}{{< katex display=true >}}
() | பியூட்டீன் ({{< katex display=true >}}
(C_4H_8)
{{< /katex >}}
) | பியூட்டைன் ()
{{< /katex >}}
...
| 5 | பென்டேன் ({{< katex display=true >}}
(C_5H_{12}{{< katex display=true >}}
() | பென்டீன் ({{< katex display=true >}}
(C_5H_{10})
{{< /katex >}}
) | பென்டைன் ()
{{< /katex >}}
...
![Figure: Test for unsaturation - Bromine water test with alkene and alkane](figure_11_2_bromine_test.png)
...
கார்பன்களுக்கிடையே இருக்கும் பிணைப்புகளின் எண்ணிக்கையையும் ({{< katex display=true >}}
(C-C{{< katex display=true >}}
(, {{< katex display=true >}}
(C=C{{< katex display=true >}}
(, {{< katex display=true >}}
(C \equiv C{{< katex display=true >}}
() வேதியியல் பண்புகளையும் குறிப்பிடும். )
{{< /katex >}}
-OH)
{{< /katex >}}
, )
...
-COOH)
{{< /katex >}}
 ஆகியவை சில வினைச் செயல் குழுக்கள் ஆகும்.

**அட்டவணை 11.2: வினைச் செயல் குழுக்கள்**

| வகை | குழு | பொது வாய்ப்பாடு | எடுத்துக்காட்டு |
|-----|------|---------------|---------------|
| ஆல்கஹால் | {{< katex display=true >}}
(-OH{{< katex display=true >}}
( | {{< katex display=true >}}
(R-OH)
{{< /katex >}}
 | )
...
{{< /katex >}}
 (எத்தனால்) |
| ஆல்டிஹைடு | {{< katex display=true >}}
(-CHO{{< katex display=true >}}
( | {{< katex display=true >}}
(R-CHO)
{{< /katex >}}
 | )
...
{{< /katex >}}
 (எத்தனால்டிஹைடு) |
| கீட்டோன் | {{< katex display=true >}}
(>C=O{{< katex display=true >}}
( | {{< katex display=true >}}
(R-CO-R')
{{< /katex >}}
 | )
...
{{< /katex >}}
 (புரப்போன்) |
| கார்பாக்சிலிக் அமிலம் | {{< katex display=true >}}
(-COOH{{< katex display=true >}}
( | {{< katex display=true >}}
(R-COOH)
{{< /katex >}}
 | )
...
{{< /katex >}}
 (எத்தனாயிக் அமிலம்) |
| எஸ்டர் | {{< katex display=true >}}
(-COOR{{< katex display=true >}}
( | {{< katex display=true >}}
(R-COOR')
{{< /katex >}}
 | )
...
{{< /katex >}}
 (மெத்தில் எத்தனோயேட்) |
| ஈதர் | {{< katex display=true >}}
(-O-{{< katex display=true >}}
( | {{< katex display=true >}}
(R-O-R')
{{< /katex >}}
 | )
...
காரணமான ஒரு அணு அல்லது அணுக்கள் அடங்கிய குழு சய அச் சேர்மத்தின் வினைச் செயல் குழுவாகும். ஒரு கரிமச் சேர்மத்தின் வேதிப் பண்புகள் அனைத்தும் அதன் வினைச் செயல் குழுவால் உறுதிப்படுத்தப்படுகின்றன. ஆனால் அச் சேர்மத்தின் இயற்பியல் பண்புகள் மூலக்கூறின் எஞ்சியப் பகுதியால் உறுதிப்படுத்தப்படுகின்றன. கார்பன்களுக்கிடையே இருக்கும் பிணைப்புகளின் எண்ணிக்கையையும் ({{< katex display=true >}}
(C-C{{< katex display=true >}}
(, {{< katex display=true >}}
(C=C)
{{< /katex >}}
...
(, {{< katex display=true >}}
(-COOH{{< katex display=true >}}
( ஆகியவை சில வினைச் செயல் குழுக்கள் ஆகும். உதாரணமாக ஈத்தேன் என்பது ஒரு ஹைட்ரோகார்பன். இதன் மூலக்கூறு வாய்ப்பாடு {{< katex display=true >}}
(C_2H_6{{< katex display=true >}}
(. இதில் இருக்கும் ஒரு ஹைட்ரஜனை எடுத்துவிட்டு ஒரு )
{{< /katex >}}
OH)
{{< /katex >}}
 குழுவைச் சேர்க்கும்போது நமக்கு ஆல்கஹால் கிடைக்கிறது. )
{{< /katex >}}
-OH)
{{< /katex >}}
 என் வினைக் குழுவைத் தவிர மீதமுள்ள அளைப்பை )
{{< /katex >}}
R)
{{< /katex >}}
 என எடுத்துக் கொண்டால் ஆல்கஹால் )
{{< /katex >}}
R-OH)
{{< /katex >}}
 என் வாய்ப்பாட்டால் குறிப்பிடலாம்.
...
![Figure: Functional group substitution showing ethane to ethanol conversion](figure_functional_group.png)

வாய்ப்பாடுகளுடையும் ஒத்த வேதிப் பண்புகளையும் கொண்ட ஒரு குழு அல்லது ஒரு வகையில் உள்ள கரிமச் சேர்மங்களைக் குறிப்பதற்கும். படிவரிசையில் அடுத்தடுத்த சேர்மங்கள் {{< katex display=true >}}
(CH_2)
{{< /katex >}}
 என்கிற குழுவால் வேறுபடும். அட்டவணை 11.1-ல் காட்டப்பட்டுள்ள அல்கேன் குடும்பத்தில் உள்ள கவன சில சேர்மங்களை கீழ்கண்டவாறு எழுதலாம்:

- மீத்தேன்: {{< katex display=true >}}
(CH_4)
{{< /katex >}}

- ஈத்தேன்: {{< katex display=true >}}
(CH_3CH_3)
{{< /katex >}}
...
- பியூட்டேன்: {{< katex display=true >}}
(CH_3(CH_2)_2CH_3)
{{< /katex >}}

- பென்டேன்: {{< katex display=true >}}
(CH_3(CH_2)_3CH_3)
{{< /katex >}}
...
**படிவரிசையின் பண்புகள்:**

- சேர்மங்கள் கமத்திலீன் {{< katex display=true >}}
(CH_2)
{{< /katex >}}
 என்கிற பொதுவாய்ப்பாட்டிலும் மூலக்கூறு நிறை 14 amu (அணு நிறை அலகு) வேறுபடுகின்றன
- ஒரு படிவரிசையில் உள்ள அனைத்துச் சேர்மங்களும் ஒரு வகைத் தனிமங்களையும், வினைச் செயல் குழுக்களையும் பற்றிருக்கும்
- ஒரு படிவரிசையிலுள்ள அனைத்துச் சேர்மங்களையும் ஒரு பொதுவாய்ப்பாட்டினால் குறிப்பிட இயலும். எ.கா. அல்கேன்கள் {{< katex display=true >}}
(C_nH_{2n+2})
{{< /katex >}}
...
![Figure: IUPAC name formation showing prefix + root word + suffix](figure_iupac_structure.png)
...
| குழு | பொது வாய்ப்பாடு | பின்வையாடை |
|------|---------------|-----------|
| ஆல்கஹால் | {{< katex display=true >}}
(-OH)
{{< /katex >}}
...
**எடுத்துக்காட்டு 1:** {{< katex display=true >}}
(CH_3-CH_2-CH_2-OH)
{{< /katex >}}
...
படி 3: இருப்பதால் இது ஒரு ஆல்கஹால். எனவே {{< katex display=true >}}
(-OH)
{{< /katex >}}
 குழு அண்மையில் அளையும் விதமாக கார்பன் அணுவிலிருந்து எண்ணிடுதல் தொடங்க வேண்டும். (விதி 3)
...
படி 4: {{< katex display=true >}}
(OH)
{{< /katex >}}
 குழுவின் இட எண் 1. எனவே இரண்டாம் நிலைப் பின்வையாடையாக 1-ஆல் சேர்க்க வேண்டும்.

எனவே சேர்மத்தின் பெயர்: **புரப்பேன்-1-ஆல்** அல்லது **1-புரப்பனால்**

**எடுத்துக்காட்டு 2:** {{< katex display=true >}}
(CH_3COOH)
{{< /katex >}}
...
|------------------|----------|-----------|----------|------------------------|
| 1 | மெத்தனால் ({{< katex display=true >}}
(CH_3OH{{< katex display=true >}}
() | மெத்தனால் ({{< katex display=true >}}
(HCHO)
{{< /katex >}}
) | - | மெத்தனாயிக் அமிலம் ()
{{< /katex >}}
...
| 2 | எத்தனால் ({{< katex display=true >}}
(C_2H_5OH{{< katex display=true >}}
() | எத்தனால் ({{< katex display=true >}}
(CH_3CHO)
{{< /katex >}}
) | - | எத்தனாயிக் அமிலம் ()
{{< /katex >}}
...
| 3 | புரப்பனால் ({{< katex display=true >}}
(CH_3CH_2CH_2OH{{< katex display=true >}}
() | புரப்பனால் ({{< katex display=true >}}
(CH_3CH_2CHO{{< katex display=true >}}
() | புரப்போன் ()
{{< /katex >}}
CH_3COCH_3)
{{< /katex >}}
...
## 11.6 எத்தனால் ({{< katex display=true >}}
(C_2H_5OH)
{{< /katex >}}
)
...
![Figure: Structural formula of ethanol showing C2H5OH](figure_ethanol_structure.png)
...
443K குறைந்த வெப்பநிலையில் அடர் {{< katex display=true >}}
(H_2SO_4)
{{< /katex >}}
 முன்னிலையில் எத்தனால் ஈத்தீனைத் தருகிறது.
...
அமிலங்கள் கொண்ட {{< katex display=true >}}
(K_2Cr_2O_7)
{{< /katex >}}
 கொண்டு ஆக்ஸிஜனேற்றம் செய்யும்போது எத்தனாயிக் அமிலம் உருவாகிறது.
...
இந்த வினையின்போது ஆரஞ்சு நிறமுடைய {{< katex display=true >}}
(K_2Cr_2O_7)
{{< /katex >}}
 பச்சையாக மாறுகிறது. எனவே, இது ஆல்கஹால்களைக் கண்டறியும் சோதனைக்குப் பயன்படுகிறது.

#### (iv) எஸ்டராக்குதல் (Esterification)

ஆல்கஹால், கார்பாக்சிலிக் அமிலத்துடன் வினைபுரிந்து இனிய மணமுடைய சேர்மத்தைத் தருகிறது. இச் சேர்மம் எஸ்டர் என்று அழைக்கப்படுகிறது. எத்தனால், எத்தனாயிக் அமிலத்துடன் அடர் {{< katex display=true >}}
(H_2SO_4)
{{< /katex >}}
 முன்னிலையில் எத்தில் எத்தனோயேட் என்னும் எஸ்டரைத் தருகிறது.
...
## 11.7 எத்தனாயிக் அமிலம் ({{< katex display=true >}}
(CH_3COOH)
{{< /katex >}}
)

எத்தனாயிக் அமிலம் அல்லது அசிட்டிக் அமிலம் என்பது கார்பாக்சிலிக் அமிலக் குழுவில் முக்கியத்துவம் வாய்ந்த ஒன்று. இதன் மூலக்கூறு வாய்ப்பாடு {{< katex display=true >}}
(C_2H_4O_2{{< katex display=true >}}
( அல்லது )
{{< /katex >}}
CH_3COOH)
{{< /katex >}}
. இதன் அளைப்பு வாய்ப்பாடு:
...
### 11.7.2 எத்தனாயிக் அமிலத்தின் பண்புகள்
...
டிடர்ஜெண்டுகளை தயாரிப்பதன் மூலமாக ஏராளமான மாற்றங்கள் ஏற்பட்டது. இவற்றை கடின நீரம் மற்றும் அமிலம் கொண்ட நீரில் கூடப் பயன்படுத்தலாம். சோப்பிலுள்ள கார்பாக்சிலிக் அமில உப்பின் பதிலாக டிடர்ஜெண்டுகள் என்பவை சல்போனிக் அமிலத்தின் சோடியம் அல்லது பொட்டாசியம் உப்புகள் ஆகும். இதனால் டிடர்ஜெண்டுகள் கடின நீரில் இருக்கும் {{< katex display=true >}}
(Ca^{2+}{{< katex display=true >}}
( மற்றும் )
{{< /katex >}}
Mg^{2+})
{{< /katex >}}
 ஆகியவற்றுடன் சேர்ந்து வீழ்படிவமாக்கல்கள் உருவாக்குவதில்லை. எனவே குளியலுக்குச் சோப்பை விட டிடர்ஜெண்டுகள் சிறந்தவை.
...
![Figure: Soap molecule structure showing hydrophilic and hydrophobic parts, micelle formation](figure_11_3_soap_micelle.png)
...
![Figure: Soap packaging showing TFM (Total Fatty Matter) content](figure_soap_tfm.png)
...
- டிடர்ஜெண்ட் என்பவை சல்போனிக் அமிலத்தின் சோடியம் உப்பு ஆகும். இதில் சோப்பில் உள்ள {{< katex display=true >}}
(-COOH{{< katex display=true >}}
( குழுவுக்குப் பதிலாக )
{{< /katex >}}
-SO_3H)
...
1. மூலக்கூறு வாய்ப்பாடு {{< katex display=true >}}
(C_3H_6)
{{< /katex >}}
 அந்தச் சேர்மத்தின் வகை:
   - அ. அல்கேன்
   - ஆ. அல்கீன்
   - இ. அல்கைன்
   - ஈ. ஆல்கஹால்
...
4. கீழ்கண்டவற்றில் ஒத்த வகைச் சேர்மங்களைக் குறிப்பிடுவது எது?
   - அ. {{< katex display=true >}}
(CH_4{{< katex display=true >}}
( மற்றும் )
{{< /katex >}}
C_3H_6)
{{< /katex >}}

   - ஆ. {{< katex display=true >}}
(C_2H_5OH{{< katex display=true >}}
( மற்றும் )
{{< /katex >}}
C_4H_9OH)
...
9. கூற்று எது?
   ...
   - இ. டிடர்ஜெண்டின் அயனிப் பகுதி {{< katex display=true >}}
(SO_3^-Na^+)
{{< /katex >}}
...
2. {{< katex display=true >}}
(CH_3-CH_2-CH_2-OH)
{{< /katex >}}
 என்னும் சேர்மத்திற்குப் பெயரிடும் முறையை வரிசைக் கிரமமாக எழுதுக.
...
4. கீழ்கண்ட வினைகளின் வேதி வாய்ப்பாடுகளை எழுதுக:
   ...
   - ஆ. எத்தனாயிக் அமிலம் {{< katex display=true >}}
(NaHCO_3{{< katex display=true >}}
( உடன் வினைபுரிந்து )
{{< /katex >}}
CO_2)
{{< /katex >}}
 வாயுவை வெளியிடும் வினை
   - இ. எத்தனால் அமிலப் பொட்டாசியம் டைக்ரோமேட்டுடன் புரியும் ஆக்ஸிஜனேற்ற வினை
   - ஈ. எத்தனாலின் எரிதல் வினை

### VII. உயர்சிந்தனை வினாக்கள்

1. ஆல்கஹாலின் மூலக்கூறு வாய்ப்பாடு {{< katex display=true >}}
(C_4H_{10}O{{< katex display=true >}}
(. அதில் )
{{< /katex >}}
-OH)
{{< /katex >}}
...
2. ஒரு கரிமச் சேர்மம் A என்பதன் மூலக்கூறு வாய்ப்பாடு {{< katex display=true >}}
(C_2H_4O_2)
{{< /katex >}}
. இது பதப்படுத்துதலில் பயன்படுகிறது. சமான எத்தனாலுடன் வினைபுரிந்து இனிய மணமுடைய சேர்மம் B-ஐத் தருகிறது.
...
**படம்: கார்பனும் அதன் சேர்மங்களும் - மன வரைபடம்**

![Figure: Mind map showing carbon and its compounds classification](figure_mind_map.png)
