...
weight: 7
---
# அணுக்களும் மூலக்கூறுகளும் (Atoms and Molecules)
...
### 7.1.1 ஒப்பு அணுநிறை (Relative Atomic Mass)
...
### 7.1.2 சராசரி அணுநிறை (AAM - Average Atomic Mass)
...
## 7.2 மூலக்கூறு மற்றும் மூலக்கூறு நிறை (Molecule and Molecular Mass)
...
## 7.3 ஒப்பு மூலக்கூறு நிறை (Relative Molecular Mass - RMM)
...
$$\text{மோல்களின் எண்ணிக்கை} = \frac{\text{நிறை}}{\text{அணுநிறை}} = \frac{\text{நிறை}}{\text{மூலக்கூறு நிறை}} = \frac{\text{அணுக்களின் எண்ணிக்கை}}{6.023 \times 10^{23}} = \frac{\text{மூலக்கூறுகளின் எண்ணிக்கை}}{6.023 \times 10^{23}}$$

---

## 7.5 சதவீத இணைப்பு (Percentage Composition)
...
## 7.6 அவகாட்ரோ கருதுகோட்பாடுகள் (Avogadro's Hypothesis)
...
## 7.7 ஆவி அடர்த்தி (Vapour Density - V.D.)
...
```
        ...
        -----------------------------------------
        |                  |                    |
   நவீன அணுக்         அணு              மூலக்கூறு      அவகாட்ரோ
   கோட்பாடு            |                    |         கருதுகோட்பாடுகள்
        |           அணுநிறை          மூலக்கூறு நிறை
   ஜான் டால்டன்         |                    |
   ஜே.ஜே.தாம்சன்    ஒப்பு அணுநிறை      ஒப்பு மூலக்கூறு நிறை
   ரூதர்ஃபோர்டு         |                    |
   நீல்ஸ்போர்      சராசரி அணுநிறை         மோல் தத்துவம்
   ஷ்ரோடிங்கர்
```
